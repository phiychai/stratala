...
This document describes the shared ESLint and Prettier configuration setup for
the app-platform monorepo.
...
All ESLint and Prettier dependencies are now centralized in
`packages/eslint-config/`.

## Benefits

✅ **Consistency**: All projects use the same rules ✅ **Maintainability**:
Update rules in one place ✅ **DRY**: No duplicate configuration ✅ **Type
Safety**: TypeScript-aware linting ✅ **Developer Experience**: Auto-fix and
format on save ✅ **CI/CD Ready**: Lint and format checks in pipeline
