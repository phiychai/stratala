...
This document describes the production-ready architecture for the Stratala, with AdonisJS serving as the central API gateway.
...
- **[Spaces & Profile System](./3.spaces-profile-system.md)** - Multi-tenant spaces and user profile system
...
- **[Subdomain Tenant Routing](./7.subdomain-tenant-routing.md)** - Subdomain-based tenant routing system
- **[Content Discovery System](./8.content-discovery-system.md)** - Home, My Feed, and Explore content discovery features
