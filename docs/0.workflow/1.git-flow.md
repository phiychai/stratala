...
description:
  'Complete guide to the git workflow and branching strategy for collaborative
  development'
navigation:
  title: 'Git Flow'
  order: 0
...
This project uses a Git Flow-based branching strategy optimized for
collaborative development, continuous integration, and safe production
deployments.
...
- **Naming**: Use descriptive names like `hotfix/security-patch`,
  `hotfix/payment-bug`
...
3. **Use conventional commits**: See
