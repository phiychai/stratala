...
description:
  'Development workflow, git strategies, and collaboration guidelines'
navigation:
  title: 'Workflow'
  order: 0
---

This section covers development workflows, git strategies, and best practices
...
- **[Git Flow Guide](./1.git-flow.md)** - Complete guide to branching strategy,
