...
This document identifies patterns in Vue components that could be extracted into
...
export function useUserProfile(username: string) {
  ...
  useSeoMeta({
    ...
    description:
      data.value?.user?.bio ||
      `View ${displayName.value}'s spaces and articles`,
  });
  ...
  const providers = [
    {
      ...
      onClick: () => {
        toast.add({
          title: 'Google',
          description: 'Login with Google - Coming soon',
        });
      },
    },
    {
      ...
      onClick: () => {
        toast.add({
          title: 'GitHub',
          description: 'Login with GitHub - Coming soon',
        });
      },
    },
  ];
