...
export type ScannedRoutes = {
  ALL: {
    ...
    'cms_proxy.get_item': {
      ...
      params: { collection: ParamValue; id: ParamValue };
    };
    ...
    'admin_sessions.revoke_session': {
      paramsTuple: [ParamValue];
      params: { sessionToken: ParamValue };
    };
    ...
    'engagement.track_view': {
      paramsTuple: [ParamValue, ParamValue];
      params: { contentType: ParamValue; contentId: ParamValue };
    };
    'engagement.like_content': {
      paramsTuple: [ParamValue, ParamValue];
      params: { contentType: ParamValue; contentId: ParamValue };
    };
    'engagement.unlike_content': {
      paramsTuple: [ParamValue, ParamValue];
      params: { contentType: ParamValue; contentId: ParamValue };
    };
    'engagement.get_like_status': {
      paramsTuple: [ParamValue, ParamValue];
      params: { contentType: ParamValue; contentId: ParamValue };
    };
