...
const posts = [
  {
    ...
    description:
      'Exploring how AI coding assistants are revolutionizing the way developers write code.',
    content: {
      root: {
        children: [
          {
  ...
  },
  {
    ...
    description:
      'Master the craft of code review to improve code quality and build stronger teams.',
    content: {
      root: {
        children: [
          {
  ...
  },
  {
    ...
    description:
      'A practical guide to choosing between TypeScript and JavaScript for your next project.',
    content: {
      root: {
        children: [
          {
  ...
  },
  {
    ...
    description:
      'Learn how to build and maintain design systems that scale with your organization.',
    content: {
      root: {
        children: [
          {
  ...
  },
  {
    ...
    description:
      'Learn the fundamental principles that make code readable, maintainable, and elegant.',
    content: {
      root: {
        children: [
          {
  ...
  },
  {
    ...
    description:
      'Learn how to design clean, maintainable REST APIs that developers will love to use.',
    content: {
      root: {
        children: [
          {
  ...
  },
  {
    ...
    description:
      'Understand how database indexes work and when to use them for optimal performance.',
    content: {
      root: {
        children: [
          {
  ...
  },
  {
    ...
    description:
      'Discover the most useful npm packages that will boost your Node.js development productivity.',
    content: {
      root: {
        children: [
          {
  ...
  },
  {
    ...
    description:
      'Learn advanced CSS selector techniques to write more efficient and maintainable stylesheets.',
    content: {
      root: {
        children: [
          {
  ...
  },
  {
    ...
    description:
      'Learn how to create websites that work beautifully on all devices and screen sizes.',
    content: {
      root: {
        children: [
          {
...
async function seed() {
  ...
  try {
    ...
    const authorId =
      typeof usersResult.docs[0].id === 'number'
    ...
    if (tenantsResult.docs && tenantsResult.docs.length > 0) {
      tenantId =
        typeof tenantsResult.docs[0].id === 'number'
      ...
      try {
        ...
        if (post.image_url) {
          try {
            ...
            imageId =
              typeof uploadedMedia.id === 'number' ? uploadedMedia.id : Number(uploadedMedia.id)
            console.log(`  ✅ Image uploaded: ${imageId}`)
          } catch (error) {
            console.error(
              `  ⚠️  Warning: Image upload failed: ${error instanceof Error ? error.message : String(error)}`,
            )
        ...
        try {
          ...
          const tenantFieldRejected =
            tenantId !== null && /assigned tenant|tenant/i.test(primaryMessage)
