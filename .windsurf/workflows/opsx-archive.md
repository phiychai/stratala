...
4. **Assess delta spec sync state**
   ...
   **Prompt options:**
   ...
   If user chooses sync, execute `/opsx:sync` logic. Proceed to archive
...
Before archiving, run `/opsx-plane-sync <name>` to ensure all completed tasks
are marked **Done** in the Plane **Stratala** project.
